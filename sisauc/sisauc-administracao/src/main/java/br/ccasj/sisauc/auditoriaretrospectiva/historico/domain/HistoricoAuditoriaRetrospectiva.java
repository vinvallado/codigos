...
public class HistoricoAuditoriaRetrospectiva extends EntidadeHistoricoGenerica {
	...
	public HistoricoAuditoriaRetrospectiva() {
		super();
	}
	public HistoricoAuditoriaRetrospectiva(AuditoriaRetrospectiva auditoriaRetrospectiva) {
		this();
	...
	public HistoricoAuditoriaRetrospectiva(AuditoriaRetrospectiva auditoriaRetrospectiva, ItemGAB itemGAB) {
		this();
		this.auditoriaRetrospectiva = auditoriaRetrospectiva;
		this.valorApresentado = auditoriaRetrospectiva.getValorApresentado();
		this.realizado = auditoriaRetrospectiva.isRealizado();
