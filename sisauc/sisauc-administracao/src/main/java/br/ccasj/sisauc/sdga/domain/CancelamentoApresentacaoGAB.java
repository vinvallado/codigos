...
@Entity
@Table(name="cancelamento_apresentacao_gab", schema=EntidadeGenerica.SCHEMA_SDGA)
@AttributeOverride(name = "id", column = @Column(name = "id", insertable = false, updatable = false))
public class CancelamentoApresentacaoGAB extends AcaoSDGA {

	private static final long serialVersionUID = 1385183632792178796L;

	private static final String SEQ_NAME = "cancelamento_apresentacao_gab_seq";
