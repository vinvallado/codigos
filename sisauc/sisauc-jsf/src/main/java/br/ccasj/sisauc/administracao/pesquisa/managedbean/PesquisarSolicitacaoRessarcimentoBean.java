...
@Scope(value = "view")
@Service(value = "pesquisarSolicitacaoRessarcimentoBean")
public class PesquisarSolicitacaoRessarcimentoBean implements Serializable {

	private static final long serialVersionUID = 8908377406326874836L;

	@Autowired
	private PesquisarSolicitacaoRessarcimentoService pesquisarSolicitacaoRessarcimentoService;
	@Autowired
	private OrganizacaoMilitarDAO organizacaoMilitarDAO;

	private ParametrosPesquisaSolicitacaoRessarcimento parametros = new ParametrosPesquisaSolicitacaoRessarcimento();	
	private List<ResultadoPesquisaSolicitacaoRessarcimentoVO> solicitacoes = new ArrayList<ResultadoPesquisaSolicitacaoRessarcimentoVO>();
	...
	private void carregarValoresColunas(){
		DataTable dataTable = (DataTable) FacesContext.getCurrentInstance().getViewRoot().findComponent("pesquisa-solicitacao-ressarcimento-form:resultado");
	...
	public void pesquisar(){
		setSolicitacoes(pesquisarSolicitacaoRessarcimentoService.pesquisar(parametros));
	}

	public PesquisarSolicitacaoRessarcimentoService getPesquisarSolicitacaoRessarcimentoService() {
		return pesquisarSolicitacaoRessarcimentoService;
	}

	public void setPesquisarSolicitacaoRessarcimentoService(
			PesquisarSolicitacaoRessarcimentoService pesquisarSolicitacaoRessarcimentoService) {
		this.pesquisarSolicitacaoRessarcimentoService = pesquisarSolicitacaoRessarcimentoService;
	}

	public ParametrosPesquisaSolicitacaoRessarcimento getParametros() {
		return parametros;
	}

	public void setParametros(ParametrosPesquisaSolicitacaoRessarcimento parametros) {
		this.parametros = parametros;
	}

	public List<ResultadoPesquisaSolicitacaoRessarcimentoVO> getSolicitacoes() {
		return solicitacoes;
	}

	public void setSolicitacoes(List<ResultadoPesquisaSolicitacaoRessarcimentoVO> solicitacoes) {
