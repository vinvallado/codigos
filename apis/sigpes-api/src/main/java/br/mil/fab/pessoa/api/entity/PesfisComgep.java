...
@Entity
@Table(name="VW_PESFIS_COMGEP_DW")
public class PesfisComgep implements Serializable {
	...
	@OneToOne
	@JoinColumn(name="CD_ORG_ADM")
	private Organizacao orgAdm;
	
	@OneToOne
	@JoinColumn(name="SG_ORG_ADICAO",referencedColumnName="SG_ORG")
	private Organizacao orgAdido;

	@OneToOne
	@JoinColumn(name="CD_ORG_SVC")
	private Organizacao orgSvc;

	@OneToOne
	@JoinColumn(name="CD_ORG_VINC")
	private Organizacao orgVinc;
	...
	public Organizacao getOrgAdm() {
		return orgAdm;
	}

	public void setOrgAdm(Organizacao orgAdm) {
		this.orgAdm = orgAdm;
	}

	public Organizacao getOrgAdido() {
		return orgAdido;
	}

	public void setOrgAdido(Organizacao orgAdido) {
		this.orgAdido = orgAdido;
	}

	public Organizacao getOrgSvc() {
		return orgSvc;
	}

	public void setOrgSvc(Organizacao orgSvc) {
		this.orgSvc = orgSvc;
	}

	public Organizacao getOrgVinc() {
		return orgVinc;
	}

	public void setOrgVinc(Organizacao orgVinc) {
		this.orgVinc = orgVinc;
	}
